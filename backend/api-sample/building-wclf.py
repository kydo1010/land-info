# python 샘플 코드
# 건축물대장 오수정화시설 조회 (건축HUB, data.go.kr)
# 참고: https://www.data.go.kr/data/15134735/openapi.do (getBrWclfInfo)
...
url = "https://apis.data.go.kr/1613000/BldRgstHubService/getBrWclfInfo"
