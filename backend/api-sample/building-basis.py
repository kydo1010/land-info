# python 샘플 코드
# 건축물대장 기본개요 조회 (건축HUB, data.go.kr)
# 참고: https://www.data.go.kr/data/15134735/openapi.do (getBrBasisOulnInfo)
...
url = "https://apis.data.go.kr/1613000/BldRgstHubService/getBrBasisOulnInfo"
